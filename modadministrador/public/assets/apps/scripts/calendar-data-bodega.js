            ...
            $('#event_add').unbind('click').click(function(e) {
                ...
                var sendAjax = function () {
                    var dataRequest = function () {
                        ...
                        data.append('title', $('#cellar option:selected').text());
                        data.append('cellar', $('#cellar').val());
                        data.append('coordinator', form.find('input#coordinator').val());
                        data.append('formato', form.find('input#format').val());
                ...
                drop: function(date, allDay) { // this function is called when something is dropped
                    ...
                    var sendAjax = function () {
                        var dataRequest = function () {
                            ...
                            data.append('cellar', 'Día Administrativo');
                                        ...
                                        error: function (response, xhr, request) {
                                            if (response.status == 422){
                                                    swal({
                                                        ...
                                                        text: response.message || request.message,
                                                        buttonsStyling: false,
                                                        confirmButtonClass: "btn btn-success",
                                                        type: 'error',
                                                    });
