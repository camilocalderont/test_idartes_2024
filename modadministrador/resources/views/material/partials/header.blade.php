<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        {{-- BEGIN LOGO --}}
        <div class="page-logo" id="page-logo">
            <a href="javascript:;"> 
                <img style="border: solid 0px rgba(115, 119, 115, 0.35);width: 131px;position: relative;top: -22px;" src="{{ asset('images/default_logo.png') }}" alt="Logo" class="logo-default" />
            </a>         
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="{{ Auth::user()->name_last }}" class="img-circle user-profile-pic" src="" />
                            <span class="username username-hide-on-mobile"> {{ Auth::user()->name_last }} </span>
                            <i class="fa fa-angle-down"></i>
                        </a>
