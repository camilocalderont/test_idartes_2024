        ...
        <div class="ribbon ribbon-color-{{$Color}} uppercase btn-block">{{$Grupo['vc_nombre']}}
            ...
            <div class="btn-group ">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <a href="{{ route('editar_grupo_bodega', [ 'id' => $Grupo['i_pk_id']])  }}"> Editar Grupo</a>
                    </li>
                    <li>
                        <a href="{{ route('index_subgrupo_bodega', [ 'id' => $Grupo['i_pk_id']])  }}"> Agregar Subgrupo </a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        @foreach($Grupo->subgrupos as $subgrupo) 
            ...
            <div class="btn-group ">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <a href="{{ route('editar_subgrupo_bodega', [ 'id' => $subgrupo['i_pk_id']])  }}"> Editar Subgrupo</a>
                    </li>
                    <li>
                        <a href="{{ route('index_subgrupo_pregunta', [ 'id' => $subgrupo['i_pk_id']])  }}"> Agregar Preguntas </a>
                    </li>
                    <li>
                        <a href="{{ route('tabla_pregunta_subgrupo', [ 'id' => $subgrupo['i_pk_id']])  }}"> Lista de Preguntas </a>
                    </li>
                </ul>
            </div>
            </label>
