...
<div class="mt-element-list">
    <div class="mt-list-head list-simple font-white bg-green-sharp">
        ...
        <div class="mt-list-container list-simple">
            <?php 
                $var=1; 
                $SubItemGrupo=$subgrupo->preguntas->sortBy('i_pk_id');
            ?>
            ...
            <div class="row">
                    ...
                    @if($c==2)
                    <div class="col-md-2"> 
                        <div id="pulsate-regular" style="padding: 5px; outline: rgba(191, 28, 86, 0.2) solid 2px; box-shadow: rgba(191, 28, 86, 0.2) 0px 0px 10px; outline-offset: 16px;"> <b>GUARDE CAMBIOS ANTES INGRESAR </b>
                        <div class="form-group text-center">
                            <label class="control-label col-md-12">Formato temperatura.</label>
                            <a href="{{ route('index_formatostemperatura_bodega',[$id_visita,$Formulario['i_pk_id'],$pregunta['i_pk_id'],$id,$id_sede]) }}" role="button" class="btn blue" >Registrar</a>
